...
export const artigo: Artigo = {
  ...
  titulo: "Degradê masculino: qual fade combina com o seu cabelo",
  tituloSeo: "Degradê masculino: tipos de fade e qual escolher",
  resumo:
  ...
  conteudo: [
    ...
    { tipo: "h2", texto: "O que define um degradê" },
    {
      tipo: "p",
      texto:
    ...
    { tipo: "h2", texto: "Skin fade (ou fade na navalha)" },
    {
      tipo: "p",
      texto:
    ...
    { tipo: "h2", texto: "O tipo de fio muda a conta" },
    {
      tipo: "ul",
      itens: [
    ...
    {
      tipo: "destaque",
      titulo: "Leve a foto certa",
      texto: "Foto ajuda, desde que seja de alguém com tipo de cabelo parecido com o seu. O mesmo corte em fios diferentes dá resultados diferentes.",
    },
    { tipo: "h2", texto: "Como pedir sem errar" },
    {
      tipo: "p",
      texto:
